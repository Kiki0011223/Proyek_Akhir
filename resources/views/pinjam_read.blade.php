<x-app-layout>
    ...
    foreach ($dataAll as $datax) {
        if(($num%2)==1) {echo "<tr class='table-info'>";} else echo "<tr>";
            ...
            echo "<td>";
            echo "<a href=/delete_pinjam/".$datax->id_pinjam." onclick=\"return confirm('Yakin mau dihapus ?');\" class='btn btn-danger'> HAPUS</a>";
            echo "<a href=/pinjam_update/".$datax->id_pinjam." onclick=\"return confirm('Yakin data mau diedit/diupdate ?');\" class='btn btn-success'> UPDATE</a>";
            echo "</td>";
            echo "</tr>";
    ...
    <a href=/pinjam_create class='btn btn-success'> TAMBAH DATA</a>
