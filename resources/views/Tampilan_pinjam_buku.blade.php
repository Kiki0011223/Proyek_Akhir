<x-app-layout>
    ...
    <body>
        <div class="container mt-5">
            <h2>Tampilan Pinjam Buku</h2>
    
            <form action="{{ route('create_pinjam', $dataAll->id_buku) }}" method="post">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="tgl_pinjam" name="tgl_pinjam" value="{{ $dataAll->tgl_pinjam }}" required>
                </div>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-eT0atVb05ZN5IBJJtZlZLZLo9pW9Jz7NULaz9jZwFFgahpIBuFIt5b05Uf7MOA40" crossorigin="anonymous"></script>
    </body>
    </html>
    </x-app-layout>